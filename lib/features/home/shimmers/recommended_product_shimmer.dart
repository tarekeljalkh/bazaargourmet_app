...
class RecommendedProductShimmer extends StatelessWidget {
  ...
  const RecommendedProductShimmer({super.key, });

  @override
  Widget build(BuildContext context) {
    return Padding(padding: const EdgeInsets.all( Dimensions.homePagePadding),
      child: SizedBox(height: 180,
        child: Container(margin: const EdgeInsets.all(5),
          decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: ColorResources.iconBg()),
          child: Shimmer.fromColors(baseColor: Theme.of(context).cardColor,
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
              ...
              Padding(padding: const EdgeInsets.all(Dimensions.homePagePadding),
                child: Container(height: 70,width: 140, padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                    decoration: BoxDecoration(color: ColorResources.iconBg(), borderRadius: BorderRadius.circular(10))),),

              Expanded(child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
