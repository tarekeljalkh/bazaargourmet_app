...
class OrderAgainShimmerShimmer extends StatelessWidget {
  ...
  const OrderAgainShimmerShimmer({super.key, });

  @override
  Widget build(BuildContext context) {
    return ListView.builder(itemCount: 2, shrinkWrap: true,
        physics: const NeverScrollableScrollPhysics(),
        itemBuilder: (context, index){
      return Padding(
        padding: const EdgeInsets.symmetric(horizontal: Dimensions.homePagePadding, vertical: 5),
        child: SizedBox(child: Container(margin: const EdgeInsets.all(5),
            width: 300,
            ...
            child: Shimmer.fromColors(baseColor: Theme.of(context).cardColor,
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Padding(padding: const EdgeInsets.symmetric(
                  ...
                  child: Container(height: 12, padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                      decoration:  BoxDecoration(color: ColorResources.iconBg()))),

                Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeSmall, right: 100),
                  child: Container(height: 12, padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                      decoration:  BoxDecoration(color: ColorResources.iconBg()))),
