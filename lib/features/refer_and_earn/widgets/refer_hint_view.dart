...
class ReferHintView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(child: Container(decoration: BoxDecoration(
        ...
        child: Container(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
          decoration: BoxDecoration(color: Theme.of(context).primaryColor.withValues(alpha:0.1),
            border: Border(
              top: BorderSide(color: Theme.of(context).primaryColor.withValues(alpha:0.2), width: 2),
              left: BorderSide(color: Theme.of(context).primaryColor.withValues(alpha:0.2), width: 2),
              right: BorderSide(color: Theme.of(context).primaryColor.withValues(alpha:0.2), width: 2),
            ...
            Column(children: hintList.map((hint) => Row(children: [
                Container(margin: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                  ...
                  decoration: BoxDecoration(color: Theme.of(context).colorScheme.onPrimary,
                      ...
                      boxShadow: [BoxShadow(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha:0.05),
